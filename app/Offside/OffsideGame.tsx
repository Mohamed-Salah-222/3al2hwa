...
import { getRandomOffsideQuestion } from "./OffsideData";

export default function PasswordGame() {
  const [currentWord, setCurrentWord] = useState(getRandomOffsideQuestion());

  const handleNextWord = () => {
    setCurrentWord(getRandomOffsideQuestion());
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.timerContainer}>
        <GameTimer initialMinutes={1} initialSeconds={30} onTimeUp={handleTimeUp} />
      </View>
