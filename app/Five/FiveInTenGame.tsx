...
import { getRandomFiveInTenQuestion } from "./FiveData";

export default function PasswordGame() {
  const [currentWord, setCurrentWord] = useState(getRandomFiveInTenQuestion());

  const handleNextWord = () => {
    setCurrentWord(getRandomFiveInTenQuestion());
  };
