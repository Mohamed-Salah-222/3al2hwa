...
import { getRandomGuessRightQuestion } from "./AhbdData";
...
export default function AhbdGame() {
  const [currentQuestion, setCurrentQuestion] = useState<Question>(getRandomGuessRightQuestion());

  const handleNextQuestion = () => {
    setCurrentQuestion(getRandomGuessRightQuestion());
  };
